...
#endif
cpc_unister-gmbh_de@test-cpc01:~/goir-scribe-6baeb36$ ^C
cpc_unister-gmbh_de@test-cpc01:~/goir-scribe-6baeb36$ ^C
cpc_unister-gmbh_de@test-cpc01:~/goir-scribe-6baeb36$ ls -la /usr/lib/libboost_*^C
cpc_unister-gmbh_de@test-cpc01:~/goir-scribe-6baeb36$ nano src/CassandraStorage.h
cpc_unister-gmbh_de@test-cpc01:~/goir-scribe-6baeb36$ cat src/CassandraStorage.h
